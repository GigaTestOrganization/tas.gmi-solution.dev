...
<div class="page-header">
		<h3 class="text-default"><small>[ <?php echo sprintf("%'.07d\n",$person['Person']['id']); ?> ]</small> <?php echo $person['Person']['fullname']; ?> <small class="pull-right" style="font-size:10px !important;margin-top:15px;">Encoder: <?php echo $person['Person']['encoder_name'];?>&nbsp;&nbsp;|&nbsp;&nbsp;Date Created: <?php echo date('M d, Y - h:ia', strtotime($person['Person']['created']));?>&nbsp;&nbsp;|&nbsp;&nbsp;Last Modified: <?php echo date('M d, Y - h:ia', strtotime($person['Person']['modified']));?></small></h3>
</div>
<div class="box">
		<div class="row">
				<div class="col-xs-12 col-lg-offset-2 col-lg-8">
						<?php echo $this->Form->create('Person', array('inputDefaults'=>array('div'=>false, 'label'=>false), 'id'=>'EditPersonForm', 'class'=>'form-horizontal', 'role' => 'form', 'data-toggle'=>'validator')); ?>
						<div class="page-header">
						...
						<div class="form-group form-group-sm">
								...
								<div class="col-sm-10">
										<?php echo $this->Form->input('customer_id', array('class' => 'form-control easyui-combobox', 'style'=>'width:500px;', 'maxlength'=>'200', 'data-options'=>"onLoadSuccess: function(){\$(this).combobox('setValue',$(this).val());},panelHeight:'150px',required:true,prompt:'--- please select company ---'")); ?>
								</div>
						</div>
						<div class="form-group form-group-sm">
								<label class="control-label col-sm-2">Cadet Type:</label>
								<div class="col-sm-10">
										<?php echo $this->Form->input('cadet_type', array('options'=>$cadetTypes, 'class'=>'form-control easyui-combobox', 'style'=>'width:500px;', 'maxlength'=>'200', 'data-options'=>"onLoadSuccess: function(){\$(this).combobox('setValue',$(this).val());},panelHeight:'150px',required:true,prompt:'--- please select type ---'")); ?>
								</div>
						</div>
						<br/>
						<div class="page-header">
						...
						<div class="form-group form-group-sm">
								...
								<div class="col-sm-10">
										<span class="pull-right">
												<input type="submit" value="Submit" class="btn btn-sm btn-primary" data-target="#EditPersonForm" id="js-btnValidateBeforeSubmit"/>
												<a class="btn btn-sm btn-default" href="<?php echo $this->Html->url(array('controller'=>'people', 'action'=>'view', $person['Person']['id'])); ?>">Cancel</a>
										</span>
								</div>
						</div>
...
<br/><br/>
<?php
		echo $this->Html->script(array("people/person.main"));
